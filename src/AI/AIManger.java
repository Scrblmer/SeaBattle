...
public class AIManger {
    ...
    //можно ли в приватных методах работать с приватными переменными того же класса? Это нормально с точки зрения "хорошего тона"?
    private void placeShips(Field fieldToWork){
        ...
        /* посчитаем сколько каких кораблей нужно. Исходим из
         идеи, что размерПоля = количество кораблей. Из них
        ...
        //почти повторяющийся код, возможно стоит обдумать, как решить это по-другому.
